...
#define kCellIdentifier @"cellIdentifierCreateStep1ViewController"
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"create_steps1" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CreateStep2ViewController *viewController = [[CreateStep2ViewController alloc] init];
