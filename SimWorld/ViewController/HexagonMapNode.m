...
//  SimWorld
//
//  Created by Michael Rommel on 21.01.15.
...
@interface HexagonMapNode() {
    ...
    HexagonMapMesh *_terrainMesh;
    GLPlane *_groundPlane;
}

@property (nonatomic, assign) HexagonMap *map;

@end

@implementation HexagonMapNode
