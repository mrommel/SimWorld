//
//  SetupGameStep4ViewController.m
//  SimWorld
//
...
#define kCellIdentifier @"cellIdentifierSetupGameStep4ViewController"

@interface SetupGameStep4ViewController ()
...
@implementation SetupGameStep4ViewController
...
- (void)viewDidLoad {
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"setup_steps4" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [SetupGameStepContent sharedInstance].difficulty = name;

    NSLog(@"Setup content: %@", [[SetupGameStepContent sharedInstance] description]);
    
    SetupGameGenerateViewController *viewController = [[SetupGameGenerateViewController alloc] init];
