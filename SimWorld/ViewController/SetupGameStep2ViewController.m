//
//  SetupGameStep2ViewController.m
//  SimWorld
//
...
#define kCellIdentifier @"cellIdentifierSetupGameStep2ViewController"
...
@implementation SetupGameStep2ViewController
...
- (void)viewDidLoad {
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"setup_steps2" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [SetupGameStepContent sharedInstance].mapType = name;
    
    NSLog(@"Setup content: %@", [[SetupGameStepContent sharedInstance] description]);
    
    SetupGameStep3ViewController *viewController = [[SetupGameStep3ViewController alloc] init];
