...
void main() { 
    ...
    vec4 texel0 = texture2D(s_texture, v_texCoord);
    ...
    vec4 diffuseLight = (0.8 * texel0) + (0.2 * ecNormalDotLightDirection * u_directionalLight.diffuseColor * u_material.diffuseFactor);
